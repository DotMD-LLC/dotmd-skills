...
- Use the file area for personal and shared work.
- Create folders for projects or teams.
- Use search or the command palette (`Ctrl+K` or `Cmd+K`) to find work quickly.
- Open Recents to continue where you left off.
- Favorite important items for faster access.
- Switch between light and dark themes from the interface.
...
Open Share and choose the narrowest role that fits:

- Viewer for reading;
- Commenter for feedback;
- Editor for content changes.

Link access and publishing are separate decisions. See [Sharing and publishing](sharing-and-publishing.md).
