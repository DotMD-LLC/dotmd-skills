...
Use Import to bring supported text, Markdown, document, presentation, or spreadsheet content into DotMD.
...
- Markdown for portability and version control;
- document formats for further office editing;
- PDF for a stable reading or printing artifact;
- presentation formats for presenting elsewhere;
- spreadsheet formats for tabular interchange.

Available formats can vary by content type and account.
